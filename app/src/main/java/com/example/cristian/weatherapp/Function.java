        ...
        protected void onPostExecute(JSONObject json) {
            try {
                if(json != null){
                    ...
                    String wind = windObj.getString("speed") + " m/s";
                    String humidity = mainObj.getString("humidity") + "%";
                    String pressure = mainObj.getString("pressure") + " hPa";
                    ...
                    delegate.processFinish(city, description, temperature, wind, humidity, pressure, updatedOn, iconText, ""+ (json.getJSONObject("sys").getLong("sunrise") * 1000));
                    //The order of the strings depends!!! FIGURE OUT WHY!!!
                }
